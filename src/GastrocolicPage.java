...
public class GastrocolicPage extends javax.swing.JFrame {
     Connection con=null;
    ResultSet rs=null;
    PreparedStatement pst=null;

    /**
     * Creates new form GastrocolicPage
     */
    public GastrocolicPage() {
        initComponents();
     ...
     private void UpdateTable()
    {
         try{
           ...
           con=DriverManager.getConnection("jdbc:sqlite:C:\\Users\\User\\Pharmacyfile\\MedicineGastrocolic.db");
            String query="Select * from Gastrocolic";
            pst=con.prepareStatement(query);
             rs=pst.executeQuery();
            Table_Gastrocolic.setModel(DbUtils.resultSetToTableModel(rs));
        } catch(Exception e){
    ...
    private void initComponents() {
        ...
        Table_Gastrocolic = new javax.swing.JTable();
        ...
        jLabel5.setText("Gastrocolic Medicine List");
        ...
        Table_Gastrocolic.setBackground(new java.awt.Color(63, 195, 128));
        Table_Gastrocolic.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        Table_Gastrocolic.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        Table_Gastrocolic.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Table_GastrocolicMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(Table_Gastrocolic);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        String sql="delete from Gastrocolic where name =?";
        try{
    ...
    private void jButtonSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSearchActionPerformed
        ...
        try{
            String sql="select * from Gastrocolic where Name =?";
            pst=con.prepareStatement(sql);
    ...
    private void Table_GastrocolicMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Table_GastrocolicMouseClicked
        try{
           int row=Table_Gastrocolic.getSelectedRow();
           String click=(Table_Gastrocolic.getModel().getValueAt(row,0).toString());
           String sql="select * from Gastrocolic where Name='"+click+"' ";
          pst=con.prepareStatement(sql);
          rs=pst.executeQuery();
          if(rs.next()){
                String s1=rs.getString("Name");
    ...
    }//GEN-LAST:event_Table_GastrocolicMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GastrocolicPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GastrocolicPage().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable Table_Gastrocolic;
